    ...
    style   : function() {
        ...
        switch(this.options.type) {
            ...
            case 'notification':
                ...
                break;
            case 'warning':
                this.$bar.css({backgroundColor: '#FFEAA8', borderColor: '#FFC237', color: '#826200', border: '1px solid #ffc237'});
                this.$buttons.css({borderTop: '1px solid #FFC237'});
                break;
            case 'error':
                this.$bar.css({backgroundColor: '#FF8181', borderColor: '#e25353', color: '#FFF', border: '1px solid #e25353'});
                this.$message.css({fontWeight: 'bold'});
                this.$buttons.css({borderTop: '1px solid darkred'});
                break;
            case 'information':
                this.$bar.css({backgroundColor: '#78C5E7', borderColor: '#3badd6', color: '#FFF', border: '1px solid #3badd6'});
                this.$buttons.css({borderTop: '1px solid #0B90C4'});
                break;
            case 'success':
                this.$bar.css({backgroundColor: '#BCF5BC', borderColor: '#7cdd77', color: 'darkgreen', border: '1px solid #7cdd77'});
        ...
        this.$bar.css({padding: '15px', 'border-radius': '5px'}); /* adly add */
    },
    callback: {
        onShow : function() {
